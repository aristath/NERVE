...
def test_shader_templates_compile_to_vulkan_1_4_spirv(tmp_path: Path) -> None:
    ...
    shader_files = {
        ...
        "linear_batch64_cooperative_bf16_768x2048.comp",
        "linear_residual_batch16_bf16_2048x768.comp",
        "linear_residual_batch64_cooperative_bf16_2048x768.comp",
        ...
        "parallel_linear_batch64_cooperative_2way_bf16_1024x2560_2560.comp",
        ...
        "moe_topk_batch1_bf16_e64_k8.comp",
        "sparse_moe_gate_up_bf16_h768_i256_e64_k8.comp",
        "sparse_moe_gate_up_batch1_bf16_h768_i256_e64_k8.comp",
        "sparse_moe_down_bf16_h768_i256_e64_k8.comp",
        "sparse_moe_down_batch1_bf16_h768_i256_e64_k8.comp",
        "moe_reduce_bf16_h768_k8_scale1.comp",
        "moe_reduce_batch1_bf16_h768_k8_scale1.comp",
