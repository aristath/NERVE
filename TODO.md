...
2. Execute the compiled expert-granular demand-retained residency contract.
...
3. Add runtime per-layer/per-component representation selection and optimized
...
4. Run real multi-turn DeepSeek conversations with the official thinking and
...
5. Optimize measured inference until steady-state decode clears the absolute
...
6. Before every runtime-performance commit, run the established Qwen3.6-35B
