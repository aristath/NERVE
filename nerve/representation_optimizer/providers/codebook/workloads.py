...
def codebook_validation_requirements(
    *,
    ...
    checks = (
        create_validation_check(
            name="exact codebook exhaustive component sanity",
            stage="sanity",
        ...
        create_validation_check(
            name="exact codebook adversarial component inputs",
            stage="full_local",
            kind="counterexample",
            ...
            input_artifact=component_ref,
            initial_state_artifact=None,
            controls={"phase": "decode_and_prefill", "exhaustive_codebook": True},
