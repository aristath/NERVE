...
def parallel_projection_benchmark_workloads(
    ...
    return tuple(
        create_benchmark_workload(
            name=f"exact fused parallel projection {phase}",
...
def parallel_projection_validation_requirements(
    *,
    candidate: Json,
    opportunity: ParallelProjectionFusionOpportunity,
    ...
    checks.extend(
        (
            _whole_model_check(
                name="fused parallel projection fixed-token replay",
                stage="full_local",
                kind="teacher_forced",
            ...
            _whole_model_check(
                name="fused parallel projection lifecycle continuity",
                stage="full_local",
            ...
            _whole_model_check(
                name="fused parallel projection graph duplication",
                stage="full_local",
                kind="graph_edit",
            ...
            _whole_model_check(
                name="fused parallel projection alternative placement",
                stage="full_local",
                kind="placement",
            ...
            create_validation_check(
                name="fused parallel projection reasoning and long stream",
                stage="whole_model",
            ...
            create_validation_check(
                name="fused parallel projection product conversation performance",
                stage="whole_model",
                kind="free_running",
...
def _component_fixture(opportunity: ParallelProjectionFusionOpportunity) -> Json:
