...
BROADCAST_COLUMNS_TRANSPOSE_DERIVATION = (
    "broadcast_columns_then_transpose_2d"
)
...
FP8_SPARSE_GATE_UP_REPRESENTATION_TILE_ROWS = 128
FP8_SPARSE_DOWN_TILE_ROWS = 64
FP8_SPARSE_PREQUANT_GATE_UP_TILE_ROWS = FP8_SPARSE_GATE_UP_TILE_ROWS
MOE_REDUCE_LOCAL_SIZE = 256
HEAD_INTERLEAVED_SPLIT_LOCAL_SIZE = 256
FP8_LINEAR_TILE_ROWS = (16,)
FP8_OUTPUT_PROJECTION_TILE_ROWS = 32
FP8_LINEAR_MIN_WORKGROUPS = 1
FP8_FUSED_FFN_TILE_ROWS = 16
FP8_PREQUANT_TILE_ROWS = 16
Q8_0_GROUP_SIZE = 32
