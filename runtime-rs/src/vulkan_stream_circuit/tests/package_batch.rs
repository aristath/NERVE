...
fn distributed_batch_keeps_island_internal_activations_private_to_each_shard() {
    ...
    let dispatch = |dispatch_index,
        ...
        selected_resource_activations: Vec::new(),
        ...
        row_alignment: 1,
        input_activation,
        input_distribution: nerve_execution_contracts::InputDistribution::Routed,
        auxiliary_input_activations: Vec::new(),
        auxiliary_input_distributions: Vec::new(),
        output_activation,
        output_collection: nerve_execution_contracts::OutputCollection::Routed,
        reduction: None,
