...
fn runtime_prompt_timing_report(
    ...
    scheduler_step_count: usize,
    activation_batch_count: usize,
    prefill_activation_batch_count: usize,
    decode_activation_batch_count: usize,
    max_activation_batch_width: usize,
    physical_multi_stream_batch_count: usize,
    max_physical_multi_stream_batch_width: usize,
    max_pending_activation_count: usize,
