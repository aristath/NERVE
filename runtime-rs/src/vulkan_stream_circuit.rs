...
use crate::vulkan_compute::{
    ...
    VulkanMemoryAdmissionAllocationClass, VulkanResidentBuffer, VulkanResidentBufferCopy,
    VulkanResidentBufferCopyBatch, VulkanResidentBufferFillRange, VulkanResidentBufferMemoryDomain,
