...
use crate::vulkan_compute::{
    ...
    VulkanMemoryAdmissionAllocationClass, VulkanMemoryAdmissionScope, VulkanResidentBuffer,
    VulkanResidentBufferCopy, VulkanResidentBufferCopyBatch, VulkanResidentBufferFillRange,
    VulkanResidentBufferMemoryDomain, VulkanResidentBufferPool, VulkanResidentBufferPoolAllocation,
    VulkanResidentBufferPoolKey, VulkanResidentBufferRangeCopy, VulkanResidentBufferReadRange,
    VulkanResidentBufferReadbackBinding, VulkanResidentBufferUpdateRange,
...
use crate::vulkan_distributed::{
    ...
    VulkanPhysicalExecutionTransportKind, VulkanSelectedResourceAssignment,
    VulkanSelectedResourceConcurrentAssignment, VulkanSelectedResourceConcurrentStreamDemand,
    ...
    physical_execution_island_kind, record_vulkan_physical_execution_island_submission,
    replay_exact_execution_cases_to_phase, resolved_physical_execution_islands,
    selected_resource_activation, selected_resource_placements_fit_phase_participants,
    selected_resource_placements_from_execution_plan,
    try_plan_concurrent_selected_resource_reconfiguration, try_plan_selected_resource_placement,
